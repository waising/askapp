...
public class TabPageIndicatorJuniorTohigh extends HorizontalScrollView implements PageIndicator {
    /**
    ...
    private final LinearLayout mTabLayout;//总的linearLayout
    ...
    public TabPageIndicatorJuniorTohigh(Context context) {
        this(context, null);
    }

    public TabPageIndicatorJuniorTohigh(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void notifyDataSetChanged() {
        ...
        PagerAdapter adapter = mViewPager.getAdapter();//获取viewPager的adapter
    ...
    private class TabView extends RelativeLayout {//每个的布局
        private int mIndex;

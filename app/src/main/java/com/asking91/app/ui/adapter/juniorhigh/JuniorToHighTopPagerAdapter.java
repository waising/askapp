...
public class JuniorToHighTopPagerAdapter extends PagerAdapter {
    ...
    public JuniorToHighTopPagerAdapter(List<String> dataList, List<String> bigDataList, String courseType) {
        mDataList = dataList;
    ...
    public Object instantiateItem(final ViewGroup container, int position) {
        ...
        draweeView.setScaleType(ImageView.ScaleType.CENTER_CROP);//设置图片显示方式
        draweeView.setMaxWidth(width);//设置宽度为屏幕宽度
